...
class ClientGUI:
    ...
    combo = ttk.Combobox(root, values=["Sezar", "Normal","Vigenere","Rail Fence","Route Chiper","Substituion Chiper","Play Fair","Affine","Polybius Chiper","Pipgen Chiper"], state="readonly")
